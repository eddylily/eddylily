...
- Mainly using GameMaker
- Learning C++, Python, HTML & CSS, etc.
- Lang: Korean(Native), Japanese(Advanced), English(Intermediate)
...
### `📨 Contacts`
- E-mail: edxnya@gmail.com
- Instagram: [@edxnya](https://instagram.com/edxnya)
- Twitter: [@edxnya](https://twitter.com/edxnya)
